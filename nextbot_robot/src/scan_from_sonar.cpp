...
int main(int argc, char** argv){
	...
	sonar_1_subscriber_ = n.subscribe("nextbot/range_sonar_1", 100, sonar1Callback);
	ros::Subscriber sonar_2_subscriber_;
	sonar_2_subscriber_ = n.subscribe("nextbot/range_sonar_2", 100, sonar2Callback);
	ros::Subscriber sonar_3_subscriber_;
	sonar_3_subscriber_ = n.subscribe("nextbot/range_sonar_3", 100, sonar3Callback);
	ros::Subscriber sonar_4_subscriber_;
	sonar_4_subscriber_ = n.subscribe("nextbot/range_sonar_4", 100, sonar4Callback);
	ros::Subscriber sonar_5_subscriber_;
	sonar_5_subscriber_ = n.subscribe("nextbot/range_sonar_5", 100, sonar5Callback);
	ros::Subscriber sonar_6_subscriber_;
	sonar_6_subscriber_ = n.subscribe("nextbot/range_sonar_6", 100, sonar6Callback);
	ros::Subscriber sonar_7_subscriber_;
	sonar_7_subscriber_ = n.subscribe("nextbot/range_sonar_7", 100, sonar7Callback);
	ros::Subscriber sonar_8_subscriber_;
	sonar_8_subscriber_ = n.subscribe("nextbot/range_sonar_8", 100, sonar8Callback);
	ros::Subscriber sonar_9_subscriber_;
	sonar_9_subscriber_ = n.subscribe("nextbot/range_sonar_9", 100, sonar9Callback);
	ros::Subscriber sonar_10_subscriber_;
	sonar_10_subscriber_ = n.subscribe("nextbot/range_sonar_10", 100, sonar10Callback);
	ros::Subscriber sonar_11_subscriber_;
	sonar_11_subscriber_ = n.subscribe("nextbot/range_sonar_11", 100, sonar11Callback);
	ros::Subscriber sonar_12_subscriber_;
	sonar_12_subscriber_ = n.subscribe("nextbot/range_sonar_12", 100, sonar12Callback);
